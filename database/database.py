...
SQLALCHEMY_DATABASE_URL = "postgresql+asyncpg://" + get_config("DATABASE", "USER") + ":" + get_config("DATABASE", "PASSWORD") + "@" + get_config("DATABASE", "HOST") + ":" + get_config("DATABASE", "PORT") + "/" + get_config("DATABASE", "NAME")
